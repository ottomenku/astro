<div class="rounded-xl border border-amber-200 bg-amber-50/40 p-5 sm:p-6 space-y-6" id="horoscopeExplanationPanel">
    <p class="text-xs text-center text-amber-900/80" id="horoscopeExplanationDurationHint">{{ __('horoscope.explanation_duration_hint') }}</p>

    <div class="text-center space-y-2">
        <p class="hidden text-xs font-semibold uppercase tracking-wide text-amber-700" id="horoscopeExplanationBadge"></p>
        <p class="text-xs text-amber-800/80" id="horoscopeExplanationMeta"></p>
    </div>

    <div class="text-center text-sm text-gray-600" id="horoscopeExplanationLoading">{{ __('horoscope.explanation_loading') }}</div>
